resource "signalfx_detector" "mem_historical_norm" {
  name         = "${var.o11y_prefix} Mem utilization % greater than historical norm"
...
resource "signalfx_detector" "mem_historical_cyclical_norm" {
  name         = "${var.o11y_prefix} Memory utilization % greater than 3.5 std dev compared to the same time window over the last 3 days"
